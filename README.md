...
| 2️⃣ | [🩺 Disease Prediction from Medical Data](./CodeAlpha_Disease_Prediction_from_Medical_Data)  | Predicts the likelihood of heart disease from patient medical data using Logistic Regression, Random Forest & SVM. 🟢[Details](CodeAlpha___Disease_Prediction_from_Medical_Data/README_tassk2.md)|
